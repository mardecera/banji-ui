...
export const getButtonStyles = tv({
	...
	variants: {
		variant: {
			solid: "bg-teal-700 text-slate-50 shadow-[0_8px_24px_rgba(15,118,110,0.35)] hover:bg-teal-800",
			ghost: "bg-transparent text-teal-700 border border-teal-700 hover:bg-teal-100"
		}
	},
	defaultVariants: {
		variant: "solid"
